...
void ui_ScreenPageMain_screen_init(void)
{
    ...
    lv_obj_set_style_radius(ui_ScreenPageMain, 360, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_SpinnerMainPage, 360);
    lv_obj_set_height(ui_SpinnerMainPage, 360);
    ...
    lv_obj_set_width(ui_ArcGearNumBack,340);
    lv_obj_set_height(ui_ArcGearNumBack,340);
    ...
    // White divider lines - using center-aligned objects for precision
    // Vertical divider (separates RPM from Speed)
    lv_obj_t *div_v = lv_obj_create(ui_ScreenPageMain);
    lv_obj_remove_style_all(div_v);
    lv_obj_set_width(div_v, 1);
    lv_obj_set_height(div_v, 110);
    lv_obj_set_align(div_v, LV_ALIGN_CENTER);
    lv_obj_set_y(div_v, -30);
    lv_obj_set_style_bg_color(div_v, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(div_v, 80, LV_PART_MAIN);
    lv_obj_clear_flag(div_v, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);

    // Horizontal divider (separates top data from bottom)
    lv_obj_t *div_h = lv_obj_create(ui_ScreenPageMain);
    lv_obj_remove_style_all(div_h);
    lv_obj_set_width(div_h, 260);
    lv_obj_set_height(div_h, 1);
    lv_obj_set_align(div_h, LV_ALIGN_CENTER);
    lv_obj_set_y(div_h, 30);
    lv_obj_set_style_bg_color(div_h, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(div_h, 80, LV_PART_MAIN);
    ...
    lv_obj_set_width(ui_LabelGeningRpmText, 170);
    lv_obj_set_height(ui_LabelGeningRpmText, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_LabelGeningRpmText, -75);
    lv_obj_set_y(ui_LabelGeningRpmText, -50);
    lv_obj_set_align(ui_LabelGeningRpmText, LV_ALIGN_CENTER);
    lv_label_set_long_mode(ui_LabelGeningRpmText, LV_LABEL_LONG_CLIP);
    lv_label_set_text(ui_LabelGeningRpmText, "0");
    lv_obj_set_style_text_align(ui_LabelGeningRpmText, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LabelGeningRpmText, &ui_font_FontTypoderSize44, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelGeningRpmUnitText, -75);
    ...
    lv_obj_set_style_text_font(ui_LabelGeningRpmUnitText, &ui_font_FontTypoderSize28, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_LabelCarSpeedText = lv_label_create(ui_ScreenPageMain);
    lv_obj_set_width(ui_LabelCarSpeedText, 150);
    lv_obj_set_height(ui_LabelCarSpeedText, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_LabelCarSpeedText, 75);
    lv_obj_set_y(ui_LabelCarSpeedText, -50);
    lv_obj_set_align(ui_LabelCarSpeedText, LV_ALIGN_CENTER);
    lv_label_set_long_mode(ui_LabelCarSpeedText, LV_LABEL_LONG_CLIP);
    lv_label_set_text(ui_LabelCarSpeedText, "0");
    lv_obj_set_style_text_align(ui_LabelCarSpeedText, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LabelCarSpeedText, &ui_font_FontTypoderSize44, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelCarSpeedUnitText, 75);
    ...
    lv_obj_set_style_text_font(ui_LabelCarSpeedUnitText, &ui_font_FontTypoderSize28, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelGearNumText, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_LabelGearNumText, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelGearNumText, &ui_font_FontTypoderSize44, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelMainMlieageText, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_LabelMainMlieageText, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelMainMlieageText, &ui_font_FontTypoderSize56, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelMainMieageNum, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_LabelMainMieageNum, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelMainMieageNum, &ui_font_FontTypoderSize28, LV_PART_MAIN | LV_STATE_DEFAULT);
