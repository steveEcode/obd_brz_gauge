...
void ui_ScreenPageSpeed_screen_init(void)
{
    ...
    lv_obj_set_width(ui_SpinnerSpeedPage, 360);
    lv_obj_set_height(ui_SpinnerSpeedPage, 360);
    lv_obj_set_align(ui_SpinnerSpeedPage, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_SpinnerSpeedPage, LV_OBJ_FLAG_CLICKABLE);      /// Flags
    lv_obj_set_style_arc_color(ui_SpinnerSpeedPage, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
