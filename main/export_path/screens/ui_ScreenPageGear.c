...
void ui_ScreenPageGear_screen_init(void)
{
    ...
    lv_obj_set_width(ui_SpinnerGearPage, 360);
    lv_obj_set_height(ui_SpinnerGearPage, 360);
    lv_obj_set_align(ui_SpinnerGearPage, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_SpinnerGearPage, LV_OBJ_FLAG_CLICKABLE);      /// Flags
    lv_obj_set_style_arc_color(ui_SpinnerGearPage, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
